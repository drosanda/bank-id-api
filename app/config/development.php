 ...
 * @var string
 */
$site = "http://".$_SERVER['HTTP_HOST']."/seme/bank/";
/**
 * URL parse method
...
$semevar['site_name'] = 'Seme Bank (ID)';
$semevar['site_name_admin'] = 'Seme Bank Admin';
$semevar['site_version'] = '1.0.0';
$semevar['site_title'] = 'Seme bank name provider API';
$semevar['site_description'] = 'Multipurpose bank provider, Indonesia version.';
...
$semevar['site_suffix_admin'] = ' - Admin Seme bank';
